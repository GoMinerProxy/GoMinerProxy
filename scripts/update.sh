#!/bin/bash
wget https://github.com/GoMinerProxy/GoMinerProxy/releases/download/1.0.4/GoMinerProxy_v1.0.4_linux_amd64.tar.gz -O GoMinerProxy_v1.0.4_linux_amd64.tar.gz

screen -X -S go_miner_proxy quit
rm -rf ./go_miner_proxy/GoMinerProxy

tar -zxvf GoMinerProxy_v1.0.4_linux_amd64.tar.gz -C ./go_miner_proxy
...
echo "GoMinerProxy 已經更新至V1.0.3版本並啟動"
