...
install(){
    ...
    wget https://github.com/GoMinerProxy/GoMinerProxy/releases/download/1.4.0/GoMinerTool_v1.4.0_linux_amd64.tar.gz -O /root/GoMinerTool_v1.4.0_linux_amd64.tar.gz --no-check-certificate
