...
install(){
    ...
    wget https://github.com/GoMinerProxy/GoMinerProxy/releases/download/1.3.8/GoMinerProxy_v1.3.8_linux_amd64.tar.gz -O /root/GoMinerProxy_v1.3.8_linux_amd64.tar.gz
    tar -zxvf /root/GoMinerProxy_v1.3.8_linux_amd64.tar.gz -C /root/go_miner_proxy
    ...
    sleep 2s
    echo "GoMinerProxy V1.3.8已經安裝到/root/go_miner_proxy"
...
update(){
    ...
    sleep 2s
    echo "GoMinerProxy 已經更新至V1.3.8版本並啟動"
    cat /root/go_miner_proxy/pwd.txt
    echo ""
