...
install(){    
    ...
    wget https://github.com/GoMinerProxy/GoMinerProxy/releases/download/1.2.5/GoMinerProxy_v1.2.5_linux_amd64.tar.gz -O /root/GoMinerProxy_v1.2.5_linux_amd64.tar.gz
