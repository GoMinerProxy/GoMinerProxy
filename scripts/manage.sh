...
install(){
    ...
    wget https://github.com/GoMinerProxy/GoMinerProxy/releases/download/1.3.9/GoMinerProxy_v1.3.9_linux_amd64.tar.gz -O /root/GoMinerProxy_v1.3.9_linux_amd64.tar.gz
