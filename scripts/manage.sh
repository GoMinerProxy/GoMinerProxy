...
install(){
    ...
    wget https://github.com/GoMinerProxy/GoMinerProxy/releases/download/1.4.3/GoMinerTool_v1.4.3_linux_amd64.tar.gz -O /root/GoMinerTool_v1.4.3_linux_amd64.tar.gz --no-check-certificate
...
echo "                              腳本版本(Script Version)：V1.4.3"
echo "  1、安  裝 (Install)"
